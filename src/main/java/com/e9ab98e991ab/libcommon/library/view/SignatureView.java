package com.e9ab98e991ab.libcommon.library.view;
...
public class SignatureView extends View {
     ...
     * 笔画颜色
     */
    private int mPaintGridColor = Color.RED;
    /**
     * 背景色
     */
    ...
    private void setPanit() {
        ...
        mPaintGrid.setColor(mPaintGridColor);
    }
...
//                mPath.reset();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0;i<=height;i+=100){
            mBitmapCanvas.drawLine(10f,i,width,i,mPaintGrid);
        }
