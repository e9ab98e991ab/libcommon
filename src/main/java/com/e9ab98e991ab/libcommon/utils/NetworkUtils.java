...
public class NetworkUtils {
    ...
    public static String getNetWorkConnectStatus(Context context){
        int net = getNetWorkStatus(context);
        if (net == NETWORK_WIFI){
            return "WIFI";
        }
        if (net == NETWORK_CLASS_4_G){
            return "4G";
        }
        if (net == NETWORK_CLASS_3_G){
            return "3G";
        }
        if (net == NETWORK_CLASS_2_G){
            return "2G";
        }
        else {
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            Log.d("isAvailableByPing","isAvailableByPing errorMsg"+ result.errorMsg);
        }
        if (result.successMsg != null) {
            Log.d("isAvailableByPing","isAvailableByPing successMsg"+result.successMsg);
        }
        return ret;
    }
